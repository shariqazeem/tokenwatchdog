      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-8">
        ...
        <div className="mb-10">
          <div className="max-w-2xl">
            ...
            <p className="text-sm text-[var(--muted-foreground)] mb-5">
              Enter a contract address to run a 9-dimensional risk analysis
            </p>
          </div>
        ...
        {scanning && (
          <div className="text-center py-20">
            ...
            <p className="text-[var(--muted-foreground)] text-sm">
              Running 9-dimensional risk analysis...
            </p>
            <p className="text-[var(--muted-foreground)] text-xs mt-1">
              Checking honeypot, taxes, holders, developer, liquidity, manipulation, bundles, verification, clusters
            </p>
          </div>
        )}
